...
$if(graphics)$$if(logo)$\Oldincludegraphics[width=$if(width)$$width$$else$0.2$endif$\textwidth, $if(logoposition)$$logoposition$$else$left$endif$]{$logo$}$else$$endif$$endif$
