...
### load data files
#### define file path
inPath <- "U:\\OSCRP\\CRM\\^ CRM\\~ Reports and Presentations\\~ Run Recon. and Forecasts\\Willamette\\Run Forecasts\\Willamette spring Chinook forecasts\\Input\\~Input Data\\"

#### Willamette return data
load(
  file = paste(
    inPath, "willChsRet.rda",
    sep = ""
    )
  )
