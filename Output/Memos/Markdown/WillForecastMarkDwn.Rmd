...
hat_esc_goals <- data.frame(hatch_pred_low = c(0,
                                               seq(40000,90000,10000),
                                               100001),
                            hatch_pred_hi = c(seq(39999,89999,10000),
                                              100000,
                                              1000000),
                            will_falls = c(20000,
                                           22000,
...
hat_alloc <- data.frame(hatch_pred_low = c(0,
                                           23000,
                                           40000,
                                           45000,
                                           50000,
