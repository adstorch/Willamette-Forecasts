...
The total return of adipose-fin-marked hatchery fish to the Columbia River mouth in `r as.numeric(format(Sys.Date(), '%Y'))-1` is estimated to be `r format(as.numeric(willChsRet.dat[nrow(willChsRet.dat)-1,3] + willChsRet.dat[nrow(willChsRet.dat)-2,4] + willChsRet.dat[nrow(willChsRet.dat)-3,5] + willChsRet.dat[nrow(willChsRet.dat)-4,6])-as.numeric(willChsHWprop.dat[nrow(willChsHWprop.dat),5]), big.mark = ",")`, compared to `r format(as.numeric(prior.will.predns[12,2]), big.mark = ",")` (95% credible interval: `r format(as.numeric(prior.will.predns[12,3]), big.mark = ",")`–`r format(as.numeric(prior.will.predns[12,4]), big.mark = ",")`) fish expected.  Counts at the Willamette Falls fishway indicate that 31,937 fin-marked hatchery fish and 6,692 unmarked fish passed the fish ladder.  The full reconstruction of the 2022 return is shown in Table 2.